...
8. Switch - used as a switch case in lang feature same here also where the path matchws from top to bottom that route containing component will be rendered.
